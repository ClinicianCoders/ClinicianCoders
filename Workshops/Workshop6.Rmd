...
- Try filling in the practice to compute the correct summary statistic (`mean` or `median`) on the variable `cchic$urea`. Use `print` to print our your result. Remember to remove NA's if needed. 
