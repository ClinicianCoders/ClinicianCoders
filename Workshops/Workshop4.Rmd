...
![Convert data spread over several variables into a single one](../Images/gatherspread.png)

::: notes
Warn them that this concept takes a while to grasp.
Also warn them that in the temp_point column, it should in fact say "temp_c" and "temp_nc".
:::
