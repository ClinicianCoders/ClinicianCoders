...
R is a statistical computing language; statistics uses vectors, matrices and dataframes. 
...
Two core principles that sit behind any programming language such as `R` are the use of control flow and loops. Control flow allows you to flexibly change what you code does depending on whether a condition is met and loops allow you to execute code across many iterations. Together, these allow you to easily perform complex tasks tailored to your input, any number of times you need. 
...
# can be read is if condition_a is met
# then do_something
if(condition_a){
...
Loops are fundamental to any code. In reality, you've actually called many functions that have used loops behind the scenes already. Just, they are hidden by `R` or whoever designed to function, to make that function faster or more user friendly.
...
This workshop exists in the handout however is not covered during the Clinician Coders course since 2019. 
